...
- **CatAction**: 猫咪操作记录（喂食、喂水、测体温、逗猫、绝育、体检、驱虫、清理猫砂、环境消毒、修剪指甲、洗脚、疫苗）
...
| 动作类型 | action_type | action_detail 格式 | 更新的 FSM 字段 |
|---------|-------------|-------------------|----------------|
| 喂食 | "喂食" | "喂食" | LastFeedTime |
| 喂水 | "喂水" | "喂水" | LastGiveWaterTime |
| 逗猫 | "逗猫" | "逗猫" | LastPlayTime |
| 环境消毒 | "环境消毒" | "环境消毒" | LastDisinfectTime |
